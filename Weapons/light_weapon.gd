...
var pushback_speed = 200
var combo_window_open = false
var combo_queued = false
var combo_buffered = false
var combo_chain = ["thrust", "wide_thrust", "long_stab"]
var damage_chain = [25, 30, 40]
var knockback_chain = [150, 150, 250]
var combo_index = 0
...
func start_attack():
	...
	attack_started.emit(-pivot_direction, pushback_speed, 0.7)
...
func _on_hitbox_area_area_entered(area):
	if area.is_in_group("enemy_hurtbox") and area not in hit_enemies:
		...
		CombatEffects.hitlag(0.05)
		CombatEffects.screen_shake(5.0, 0.1)
